...
const dictionaries = {
  it: {
    ...
    "widget.group.kicker": "Prenotazione di gruppo · raccontaci di più",
    "widget.group.eventType": "Tipo di evento",
    "widget.group.budget": "Budget indicativo a persona ({currency})",
    "widget.group.event.birthday": "Compleanno",
    "widget.group.event.business": "Lavoro / cena aziendale",
    "widget.group.event.event": "Evento privato",
    "widget.group.event.wedding": "Matrimonio / cerimonia",
    "widget.group.event.other": "Altro",
    "widget.group.note":
      "Per gruppi numerosi ti contatteremo entro 24h per concordare il menu e la sala dedicata.",
  ...
  en: {
    ...
    "widget.group.kicker": "Group booking · tell us more",
    "widget.group.eventType": "Event type",
    "widget.group.budget": "Per-person budget ({currency})",
    "widget.group.event.birthday": "Birthday",
    "widget.group.event.business": "Business dinner",
    "widget.group.event.event": "Private event",
    "widget.group.event.wedding": "Wedding / ceremony",
    "widget.group.event.other": "Other",
    "widget.group.note":
      "For larger parties we'll be in touch within 24h to agree on menu and dedicated room.",
